...
export interface ApiSubscriptionSubscription
  ...
  info: {
    description: 'Stripe subscription records. plan_tier is a free-form string matching your config/plans.js tier keys.';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    plan_tier: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    stripe_customer_id: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    stripe_subscription_id: Schema.Attribute.String & Schema.Attribute.Unique;
